...
MEAL_ITEMS = [
    "roti", "daal", "chawal", "puri", "paratha", "idli", "sambhar", "vada",
    "chutney", "papad", "salad", "mix veg", "chola", "bhatura", "paneer", "chicken"
]

MEALS = ["Puri Sabji", "Idli", "Chicken", "Kofta",
         "Rajma Chawal", "Chicken Chiili", "Mix Veg"]
...
class MealFactory(factory.django.DjangoModelFactory):
    ...
    type = factory.LazyFunction(lambda: random.choice(
        [x.value for x in Meal.MEAL_TYPE]))
